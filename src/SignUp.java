					...
					frame.getContentPane().add(lblConfirmPassword);
								...
								frame.getContentPane().add(lblConfirmPassword_1);
									...
									btnBack.addActionListener(new ActionListener() {
										...
										{
											String na,l,regno,mail,ty,psw,cpsw,conn;
											...
											try
											{
												...
												//INSERT INTO `test`.`table 3` (`na`, `ty`, `l`, `reg`, `conn`, `mail`, `psw`, `cpsm`) VALUES ('na','l','reg,'conn','mail','ty','psw','cpsw'"
												if(psw.equals(cpsw))
												{
													if(conn.length()==10)
													{
														...
														st.executeUpdate("INSERT INTO `test`.`table 3` (`na`, `ty`, `l`, `regno`, `conn`, `mail`, `psw`, `cpsm`) values('"+na+"','"+ty+"','"+l+"','"+reg+"','"+conn+"','"+mail+"','"+psw+"','"+cpsw+"')");
														
														if(ty.equals("ORPHANAGE")) {

														String table ="CREATE TABLE  `test`.`"+db+"`  ("
												                    ...
												                    + "sec INT  NOT NULL,"
												                    + "hs INT   NOT NULL,"
												                    + "tr VARCHAR(3) NOT NULL,"
												                    + "d VARCHAR(3) NOT NULL,"
												                    + "vacc VARCHAR(3) NOT NULL,"
												                    + "gc VARCHAR(3)  NOT NULL,"
												                    + "fcc INT ,"
												                    + "ff  INT,"
												                    + "ld  INT ,"
												                    + "ri  INT ,"
														...
														//JOptionPane.showMessageDialog(frame,"TABBLE CREATED SUCCESSFULLY.....");
														}
														textField_3.setText("");
														textField_1.setText("");
														textField.setText("");
